...
st.markdown("""
    <div class="legend-box">
        ...
        🟢 <span style="color:#00ff80;"><b>CALL 🟢 (Buy Signal)</b></span>: Appears below candles on support bounces or Nea Pro buy momentum.<br>
        🔴 <span style="color:#ff4b4b;"><b>PUT 🔴 (Sell Signal)</b></span>: Appears above candles on resistance rejections or Nea Pro sell momentum.<br>
...
# -----------------------------------------------------------------------------
# PROFESSIONAL PLOTLY CHART (RIGHT-SIDE Y-AXIS, CLEAN LABELS, SIMPLE DEFAULT SCROLL)
# -----------------------------------------------------------------------------
fig = go.Figure()
...
# Chart Layout with Right-Side Price Axis and Standard Manual Scroll/Zoom
fig.update_layout(
    ...
    dragmode="zoom", # Normal standard zoom behavior
    yaxis=dict(side="right", showgrid=True, gridcolor="#161b22", zeroline=False),
